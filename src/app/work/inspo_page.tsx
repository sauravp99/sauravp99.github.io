...
export default function CodeProjects() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[var(--primary)]">
      <div
        className={`flex-grow p-6 md:p-12 text-[var(--secondary)] transition-opacity duration-300 ${
      ...
      >
        <header className="mb-12">
          <Link
            href="/"
            className="text-[var(--secondary)] hover:underline mb-8 inline-block"
          >
            ← Back to Home
          </Link>
          <h1 className="text-4xl md:text-5xl font-bold mb-4 font-[family-name:var(--font-cherry-bomb-one)]">
            Coding Projects
          </h1>
